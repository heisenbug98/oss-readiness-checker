...
**GitHub remote:** `https://github.com/heisenbug98/oss-readiness-checker`
**GitHub metrics:** 0 stars, 0 forks, 0 open issues, default branch main, latest release v0.3.0
**Last pushed:** `2026-06-07T00:00:00Z`

| Status | Check | Evidence | Advice |
| --- | --- | --- | --- |
| Passed | README | `README.md` | - |
| Passed | License | `MIT` | - |
| Passed | Contributing guide | `CONTRIBUTING.md` | - |
| Passed | Code of conduct | `CODE_OF_CONDUCT.md` | - |
...
| Passed | Commit activity | `pushed 2026-06-07` | - |
| Passed | Changelog | `CHANGELOG.md` | - |
| Passed | Release tags | `v0.3.0` | - |
